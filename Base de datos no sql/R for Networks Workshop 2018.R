...
##       SC&I Methods Workshop                    ##
##       March 2018, Rutgers University           ##
##                                                ##
##       Katya Ognyanova, katya@ognyanova.net     ##
##       www.kateto.net/ruworkshop                ##
##                                                ##
##================================================##

# Handouts and example data: bitly.com/ruworkshop
# Online version of the tutoiral: kateto.net/ruworkshop
...
# Install the package "igraph" if you don't have its latest version (1.2.1) 
...
# For example (and pertinent to this workshop), igraph and statnet packages can cause
...
# For example: "blue" "dark red" "#557799" or rgb(.25, .5, .3))
# You can see the built-in colors name with colors():
colors() 
